...
<h1>Add User</h1>
<sf:form method="post" action="${pageContext.request.contextPath}/added-user" commandName="user">
<table>
...
<tr><td><input value="Add Student" type="submit" class="btn btn-success"></td> </tr>
</table>
</sf:form>
